...
1. Сохраняется layout **00-knowledge → 06-quality** + `engineering/`.
...
├── .archive/                # Устаревшие копии (spoke policy; вне индексации)
├── roadmap/                 # Roadmap / архитектура (вне индексации и пайплайнов)
...
| `.archive/`             | Снятые с публикации версии (spoke); вне индексации |
| `roadmap/`              | Roadmap / архитектура; вне индексации и обработки (как `.archive/`) |
